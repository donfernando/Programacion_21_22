...
public class Equipo {
	...
	/*
	 * Busqueda Lineal Alternativa
	 */
	private boolean dorsalYaExiste_(int dorsal) {
		int pos = 0;
		boolean existe;
		while (pos < jugadores.size() && dorsal != jugadores.get(pos).getDorsal()) {
			pos++;
		}
		existe = pos < jugadores.size();
		return existe;
	}
